...
//自定义摄像框的页面
public class ThirdActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener{
...
//    private CameraBridgeViewBase openCvCameraView;
    ...
    private DrawImageView div_paint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        div_paint=findViewById(R.id.div_paint);
        div_paint.draw(new Canvas());
...
//        尝试识别另外一个视频帧
//        Rect rectt = new Rect(grayscaleImage.width()/4, grayscaleImage.height()/4, grayscaleImage.width()/2, grayscaleImage.height()/2);
//        Mat rectMatt = new Mat(copyMat, rectt);
        Mat copyMat = new Mat();
...
//        Imgproc.resize(aInputFrame,aInputFrame,new Size(javaCameraView.getWidth(), javaCameraView.getHeight()),0.0D,0.0D,0);
//
